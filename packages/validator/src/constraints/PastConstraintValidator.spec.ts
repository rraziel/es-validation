...
describe('Past constraint validator', () => {
    ...
    it('considers a date in the past to be valid', () => {
        ...
        const pastConstraintValidator: ConstraintValidator<any> = new PastConstraintValidator(constraintDescriptor);
        const value: Date = new Date('2018-09-20T08:28:00Z');
        // when
        const result: boolean = pastConstraintValidator.isValid(value, constraintValidationContext);
        // then
